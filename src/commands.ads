...
package Commands is
   ...
   type Command is abstract limited new CLIC.Subcommand.Command with private;
...
private
   ...
   type Command is
   abstract limited new CLIC.Subcommand.Command with null record;

   procedure Set_Global_Switches
     (Config : in out CLIC.Subcommand.Switches_Configuration);

   package Sub_Cmd is new CLIC.Subcommand.Instance
     (Main_Command_Name    => Version.Command,
